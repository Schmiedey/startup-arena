...
('Maya Rodriguez', 'maya.r@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=maya'),
('Jake Holloway', 'jake.h@fastmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=jakeh'),
('Aisha Mbeki', 'aisha.m@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=aisha'),
('Tomas Guerrero', 'tomas.g@outlook.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=tomas'),
('Nina Petrov', 'nina.p@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=nina'),
('Marcus Chen', 'mchen@hey.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=marcus'),
('Priya Sharma', 'priya.s@icloud.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=priya'),
('Daniel Okafor', 'd.okafor@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=daniel'),
('Emma Lindqvist', 'emma.l@yahoo.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=emmal'),
('Kevin Tran', 'ktran@college.edu', 'https://api.dicebear.com/9.x/notionists/svg?seed=kevint'),
('Sofia Navarro', 'sofia.nav@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=sofian'),
('Ryan Patterson', 'rpatterson@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=ryanp'),
('Lena Hoffmann', 'lena.h@hey.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=lenah'),
('Raj Mehta', 'raj.m@outlook.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=rajm'),
('Crystal Washington', 'c.washington@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=crystal'),
('Dae-Jung Kim', 'djkim@fastmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=daejung'),
('Olive Martins', 'olive.m@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=olive'),
('Felix Moreau', 'felix.m@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=felixm'),
('Anika Desai', 'anika.d@hey.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=anika'),
('Zach Whitaker', 'zach.w@outlook.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=zachw'),
('Jamie Osei', 'jamie.osei@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=jamieo'),
('Mia Sorensen', 'mia.s@fastmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=mias'),
('DeShawn Mitchell', 'dmitch@college.edu', 'https://api.dicebear.com/9.x/notionists/svg?seed=deshawn'),
('Yuki Tanaka', 'yuki.t@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=yukit'),
('Gloria Vasquez', 'g.vasquez@hey.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=gloria'),
('Brian ONeill', 'b.oneill@gmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=briano'),
('Fatima Al-Rashid', 'fatima.ar@outlook.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=fatima'),
('Sam Erikson', 'sam.e@protonmail.com', 'https://api.dicebear.com/9.x/notionists/svg?seed=same')
