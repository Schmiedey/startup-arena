...
import { startOAuthSignIn } from "@/app/signin/actions";
...
function OAuthSubmitButton({
  ...
  return (
    ...
    >
      {children}
      {pending ? "Starting sign in..." : label}
    </button>
  );
}
...
export default function SignInPage() {
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(() => {
      setCallbackUrl(safeAuthRedirect(searchParams.get("callbackUrl"), window.location.origin));
    ...
    <div className="relative flex min-h-[70vh] items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="space-y-3">
          <form action={startOAuthSignIn}>
            <input type="hidden" name="callbackUrl" value={callbackUrl} />
            <OAuthSubmitButton provider="github" label="Continue with GitHub">
          ...
          <form action={startOAuthSignIn}>
            <input type="hidden" name="callbackUrl" value={callbackUrl} />
            <OAuthSubmitButton provider="google" label="Continue with Google">
