      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-none border border-border/60 bg-card px-4 py-3 text-sm font-semibold transition-colors hover:bg-panel hover:border-fire/30"
          >
