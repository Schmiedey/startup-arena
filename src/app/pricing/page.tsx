...
const plans = [
  ...
  },
  {
    ...
    price: "$19",
    cadence: "one-time",
    description: "Best for testing several ideas and getting paid-member visibility.",
    features: ["Submit up to 5 ideas", "Featured paid-member placement", "Premium founder profile and lead form", "Challenge links for each idea"],
    cta: "Buy Launch Pass",
  ...
  },
  {
    ...
    price: "$12",
    cadence: "/mo",
    description: "For repeat builders who want analytics, updates, and unlimited testing.",
    features: ["Unlimited ideas", "Category battle testing and featured slots", "Analytics, leads, and private feedback", "Founder updates and weekly digest placement"],
